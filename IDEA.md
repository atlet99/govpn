...
- ✅ Реализована полная система обфускации трафика с 6 методами
...
- [x] **Steganography методы** (2/3 завершено)
...
- [x] Интеграция с OIDC провайдерами как дополнение к классической аутентификации
- [x] Поддержка MFA (OTP) с сохранением базовой модели аутентификации
- [x] Интеграция с LDAP с упрощенной настройкой
